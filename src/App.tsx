...
const ANALYSIS_TIKTOK_GROUP_DEFINITIONS = [
  { account: 'Karilun', metrics: ['フォロワー数', 'フォロワー増加数', '投稿数', 'フォロワー/投稿', '視聴者リーチ', 'プロフ閲覧', 'URLクリック', '電話クリック', 'URLクリック率', '電話クリック率'] },
...
const ANALYSIS_YOUTUBE_GROUP_DEFINITIONS = [
  { account: 'Karilun', metrics: ['チャンネル登録数', '登録者増加数', '投稿数', '登録者/投稿', '再生数', '平均視聴時間（秒）', 'いいね数', 'コメント数'] },
  { account: '長瀬', metrics: ['チャンネル登録数', '登録者増加数', '投稿数', '登録者/投稿', '再生数', '平均視聴時間（秒）', 'いいね数', 'コメント数'] },
  { account: '西北', metrics: ['チャンネル登録数', '登録者増加数', '投稿数', '登録者/投稿', '再生数', '平均視聴時間（秒）', 'いいね数', 'コメント数'] },
  { account: '西宮市', metrics: ['チャンネル登録数', '登録者増加数', '投稿数', '登録者/投稿', '再生数', '平均視聴時間（秒）', 'いいね数', 'コメント数'] },
  { account: '八尾', metrics: ['チャンネル登録数', '登録者増加数', '投稿数', '登録者/投稿', '再生数', '平均視聴時間（秒）', 'いいね数', 'コメント数'] },
] as const
  ...
  const getSnsPropertySelectOptions = useCallback((field: SnsPropertySelectField) => {
    ...
    const recordValues = field === 'wp_registered'
      ...
      : field === 'aos_registered'
        ...
        : field === 'post_reserved'
          ? recruitmentValues
          : field === 'tiktok_reserved' || field === 'instagram_reserved' || field === 'youtube_reserved'
